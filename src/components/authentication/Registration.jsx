...
let emailRef,passRef,fullNameRef,mobileRef,confirmPassRef = useRef();
    ...
    return (
        <main className={"flex items-center h-screen  justify-center"}>
            <div className={"flex items-start justify-center gap-28"}>
                ...
                <section className={"lg:max-w-2xl max-w-xs w-full"}>
                    <div className="card-body grid lg:grid-cols-2 gap-2 p-0">
                        ...
                        <div className="form-control">
                            ...
                            <input ref={(input) => mobileRef = input} type="text"
                        ...
                        <div className="form-control relative">
                            ...
                            <input ref={(input) => passRef = input} type={passType}
                        ...
                        <div className="form-control">
                            ...
                            <input ref={(input) => confirmPassRef = input} type="password"
                                   placeholder="Enter confirm password" className="input input-bordered"
                                   required/>
                        </div>
                    </div>
