...
const AboutSohoj = () => {
    ...
    return (
        <main className={"lg:p-20 md:p-10 p-5"}>
            <h3 className={"text-[18px] text-gray-600 mb-5 font-semibold"}>About Sohojsell, The Largest Marketplace in Bangladesh!</h3>
            {
                showFull ? (
                        <section className={"flex flex-col items-start  gap-6"}>
                            <div>
                                <p className={"text-gray-500"}>Sohojsell is a platform on which you can buy and sell almost
                            ...
                            <div className={"flex flex-col gap-4"}>
                                ...
                                <p className={"text-gray-500"}>
                                    Every month, hundreds of millions of people use Sohojsell to find and sell mobiles, musical
                                    instruments, cars, houses,
                                    jobs, and more through classified ads. To sell new items or sell used items quickly,
                                    Sohojsell offers Ad Promotion
                                    features.
                                </p>
                                <p className={"text-gray-500"}>
                                    Sohojsell has an extensive collection of new and used goods, making it easier for users to
                                ...
                                <p className={"text-gray-500"}>
                                    For businesses, Sohojsell has introduced the ‘Membership’ service, which helps them expand
                                    their businesses online. Members will
                                    have their virtual shop with a Sohojsell URL with free promotions of their goods. With
                                ...
                                <p className={"text-gray-500"}>
                                    ...
                                    of active dealers on our platform, Sohojsell is the
                                    Largest Marketplace in Bangladesh.
                                </p>
                            </div>
                            <div className={"flex flex-col gap-4"}>
                                <h4 className={"text-[16px] text-gray-600 font-semibold"}>Benefits of Trading at Sohojsell</h4>
                                <p className={"text-gray-500"}>At Sohojsell, we make it so easy to connect people to buy, sell
